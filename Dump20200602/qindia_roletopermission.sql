...
--
-- Host: localhost    Database: qindia
-- ------------------------------------------------------
...
CREATE TABLE `roletopermission` (
  ...
  KEY `Permission _idx` (`idPermission`),
  KEY `role_idx` (`idRole`),
  CONSTRAINT `Permission ` FOREIGN KEY (`idPermission`) REFERENCES `permission` (`idPermission`),
...
-- Dump completed on 2020-06-02 10:49:22
